...
const CreateOrJoin = () => {
  ...
  return (
    <div>
        ...
        <button className='h-20 w-40 rounded-lg text-xl font-semibold font-Roboto bg-white shadow-md hover:scale-110 ease-out transition delay-150 hover:bg-indigo-600 hover:text-white' onClick={handleClick}>Create A DAO</button>
